...
// ANSWER: No, because it can't be run any faster to find the 4th index of any given array.
...
// ANSWER: While both functions track and record the quantities of the letters in a given String, they do in different linear space complexity. The first function stores an array contating each letter from the given String, whereas the second function only copys the string as part of its filtering process. In both cases there is the possibility for a very large variable amount of memory required to run the function.